...
输入的大文件 数据集
"""
dataset_dir                                                     = 'E:/PikachuGoDataSample/7_value_shuffle/dataset/'
"""
输入的大文件 标签集
"""
label_dir                                                       = 'E:/PikachuGoDataSample/7_value_shuffle/label/'
"""
输出的最终数据集文件的输出目录
"""
output_dataset_dir                                              = 'E:/PikachuGoDataSample/9_ultimate_value/dataset/'
"""
输出的最终数据集文件的输出目录（标签集）
"""
output_label_dir                                                = 'E:/PikachuGoDataSample/9_ultimate_value/label/'
"""
每N条数据为一个文件
"""
N                                                               = 2500
